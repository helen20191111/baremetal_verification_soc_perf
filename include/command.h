...
#define BST_SUBCMDS_RELOC(_cmdname)                                         \
...
#define BST_SUBCMDS_DO_CMD(_cmdname)                                        \
...
#ifdef CONFIG_AUTO_COMPLETE
#define BST_SUBCMDS_COMPLETE(_cmdname)                                      \
...
#define BST_SUBCMDS(_cmdname, ...)                                          \
	static cmd_tbl_t _cmdname##_subcmds[] = { __VA_ARGS__ };               \
	BST_SUBCMDS_RELOC(_cmdname)                                         \
	BST_SUBCMDS_DO_CMD(_cmdname)                                        \
	BST_SUBCMDS_COMPLETE(_cmdname)

#ifdef CONFIG_CMDLINE
#define BST_CMDREP_MKENT_COMPLETE(_name, _maxargs, _cmd_rep, _usage, _help, \
				     _comp)                                    \
	{                                                                      \
...
#define BST_CMD_MKENT_COMPLETE(_name, _maxargs, _rep, _cmd, _usage, _help,  \
				  _comp)                                       \
	{                                                                      \
#_name, _maxargs,                                              \
...
#define BST_CMD_COMPLETE(_name, _maxargs, _rep, _cmd, _usage, _help, _comp) \
	ll_entry_declare(cmd_tbl_t, _name, cmd) = BST_CMD_MKENT_COMPLETE(   \
		_name, _maxargs, _rep, _cmd, _usage, _help, _comp);

#define BST_CMDREP_COMPLETE(_name, _maxargs, _cmd_rep, _usage, _help,       \
			       _comp)                                          \
	ll_entry_declare(cmd_tbl_t, _name, cmd) =                              \
		BST_CMDREP_MKENT_COMPLETE(_name, _maxargs, _cmd_rep,        \
					     _usage, _help, _comp)

#else
#define BST_SUBCMD_START(name) static cmd_tbl_t name[] = {};
#define BST_SUBCMD_END
...
#define BST_CMD(_name, _maxargs, _rep, _cmd, _usage, _help)                 \
	BST_CMD_COMPLETE(_name, _maxargs, _rep, _cmd, _usage, _help, NULL)

#define BST_CMD_MKENT(_name, _maxargs, _rep, _cmd, _usage, _help)           \
	BST_CMD_MKENT_COMPLETE(_name, _maxargs, _rep, _cmd, _usage, _help,  \
				  NULL)

#define BST_SUBCMD_MKENT_COMPLETE(_name, _maxargs, _rep, _do_cmd, _comp)    \
	BST_CMD_MKENT_COMPLETE(_name, _maxargs, _rep, _do_cmd, "", "", _comp)

#define BST_SUBCMD_MKENT(_name, _maxargs, _rep, _do_cmd)                    \
	BST_SUBCMD_MKENT_COMPLETE(_name, _maxargs, _rep, _do_cmd, NULL)

#define BST_CMD_WITH_SUBCMDS(_name, _usage, _help, ...)                     \
	BST_SUBCMDS(_name, __VA_ARGS__)                                     \
	BST_CMDREP_COMPLETE(_name, CONFIG_SYS_MAXARGS, do_##_name, _usage,  \
